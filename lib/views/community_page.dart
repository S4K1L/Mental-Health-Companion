...
import 'package:mentalhealth/views/add_experience.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            onPressed: () {
              Get.to(() => ExperiencePage(), transition: Transition.rightToLeft);
            },
            icon: const Icon(Icons.add_circle, color: kWhiteColor, size: 26),
          ),
          const SizedBox(width: 20),
        ],
      ),
